      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="{{asset('Arsha')}}/assets/img/clients/clients-1.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{asset('Arsha')}}/assets/img/clients/clients-2.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{asset('Arsha')}}/assets/img/clients/clients-3.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{asset('Arsha')}}/assets/img/clients/clients-4.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{asset('Arsha')}}/assets/img/clients/clients-5.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{asset('Arsha')}}/assets/img/clients/clients-6.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{asset('Arsha')}}/assets/img/clients/clients-7.webp" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{asset('Arsha')}}/assets/img/clients/clients-8.webp" class="img-fluid" alt=""></div>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 d-flex align-items-center">
            <img src="{{asset('Arsha')}}/assets/img/illustration/illustration-10.webp" class="img-fluid" alt="">
          </div>
